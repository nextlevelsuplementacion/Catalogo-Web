...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  const currentImage = selectedFlavor && product.flavorImages?.[selectedFlavor] 
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white dark:bg-zinc-900 rounded-[2rem] p-4 border border-slate-100 dark:border-zinc-800 hover:border-primary/50 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-primary/10"
    >
      {product.badge && (
